...
import { WalletConfig, addressOf, encodeSignature, DecodedFullSigner, DecodedEOASigner } from '@0xsodium/config'
import { readSequenceNonce, sequenceTxAbiEncode, Transaction } from '@0xsodium/transactions'
...
const MainModuleGasEstimation = require("@0xsodium/wallet-contracts/artifacts/contracts/modules/MainModuleGasEstimation.sol/MainModuleGasEstimation.json")
